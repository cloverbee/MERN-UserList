...
function init() {
  ...
  //mongoose.connect('mongodb://E）））））））））））:××××××@cluster0-shard-00-00-qm0uv.gcp.mongodb.net:27017,cluster0-shard-00-01-qm0uv.gcp.mongodb.net:27017,cluster0-shard-00-02-qm0uv.gcp.mongodb.net:27017/1stProject?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true');
